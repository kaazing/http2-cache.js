...
var redefine = function (obj, prop, value /*, onRevert*/) {
    if (obj[prop]) {
    ...
    // if (onRevert) {
    //     Object.defineProperty(obj[prop], '_onrevert', {
    //         value: onRevert,
    //         configurable: false,
    //         enumerable: false
    //     });
...
//
// var restore = function (obj, prop) {
//     var overRiddenMethod = obj['_' + prop];
//     if (obj[prop]._onrevert) {
//         obj[prop]._onrevert(obj, overRiddenMethod);
//     }
//     Object.defineProperty(obj, prop, {
//         enumerable: obj.propertyIsEnumerable(prop),
//         value: overRiddenMethod,
//         configurable: true
//     });
//
// };
