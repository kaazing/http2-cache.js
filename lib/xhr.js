...
function enableXHROverH2(XMLHttpRequest, configuration) {
    ...
    Object.defineProperty(xhrProto, "responseType", {
        get: function () {
            return xhrInfo.get(this, 'responseType') || this._responseType || '';
        },
        set: function (value) {
            xhrInfo.put(this, 'responseType', value);
        }
    });
    Object.defineProperty(xhrProto, "_readyState", Object.getOwnPropertyDescriptor(xhrProto, "readyState"));

    Object.defineProperty(xhrProto, "readyState", {
        get: function () {
            return xhrInfo.get(this, 'readyState') || this._readyState || 0;
        },
        set: function (value) {
            xhrInfo.put(this, 'readyState', value);
        }
    });

    Object.defineProperty(xhrProto, "_timeout", Object.getOwnPropertyDescriptor(xhrProto, "timeout"));

    Object.defineProperty(xhrProto, "timeout", {
        get: function () {
            return xhrInfo.get(this, 'timeout');
        },
        set: function (value) {
            xhrInfo.put(this, 'timeout', value);
        }
    });
    */
