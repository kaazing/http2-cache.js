...
function enableXHROverH2(XMLHttpRequest, configuration) {
    ...
    redefine(xhrProto, 'send', function (body) {
        ...
        var self = this,
            ...
            fallbackOnConnectFailure = configuration.options.fallbackOnConnectFailure;
        ...
        if (configuration.isConfiguring()) {
            ...
            // Let pending request procced if proxyTransportUrl match
            if (proxyTransportUrl && fallbackOnConnectFailure) {
                configuration.once('connectFailure', function (transportUrl) {
