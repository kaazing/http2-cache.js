(function () {
    ...
    const ConfEmitter = require('./h2-utils').ConfEmitter;
    const define = require('./h2-utils').define;
    const getOrigin = require('./h2-utils').getOrigin;
    const resolvePort = require('./h2-utils').resolvePort;
    const parseUrl = require('./h2-utils').parseUrl;
    ...
    function addConfig(config) {
        ...
        const origin = getOrigin(proxyUrl);
...
////////////////////////////////////////////////// XMLHttpRequest ////////////////////////////////////////////////////
    ...
    define(xhrProto, 'send0', function send0(destination, body, proxyTransportUrl) {
        ...
        // const _onCachedResponse = function (response) {
